    ...
    <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
      ...
      <div class="w-1/2 pl-2 md:pl-0">
        <a class="text-black text-base xl:text-xl no-underline hover:no-underline font-bold"  href="#"> 
          <i class="fas fa-sun text-orange-dark pr-3"></i> FunInATL Admin Dashboard
        </a>
            </div>
        ...
        <div class="flex relative inline-block float-right">
          ...
          <div class="relative text-sm">
            ...
            <div id="userMenu" class="bg-white rounded shadow-md mt-2 absolute mt-12 pin-t pin-r min-w-full overflow-auto z-30 invisible">
              <ul class="list-reset">
              <li><a href="{{ route('admin.dashboard') }}" class="px-4 py-2 block text-black hover:bg-grey-light no-underline hover:no-underline">Dashboard</a></li>
              <li><hr class="border-t mx-2 border-grey-light"></li>
              <li><a href="{{ route('logout') }}" class="px-4 py-2 block text-black hover:bg-grey-light no-underline hover:no-underline">Logout</a></li>
              </ul>
            </div>
          </div>
      ...
      <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20" id="nav-content">
        <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
          ...
          <li class="mr-6 my-2 md:my-0">
                        <a href="{{ route('admin.locations.index') }}" class="block py-1 md:py-3 pl-1 align-middle text-grey no-underline hover:text-black border-b-2 border-white hover:border-pink">
                            <i class="fas fa-map fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Locations</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <a href="{{ route('admin.providers.index') }}" class="block py-1 md:py-3 pl-1 align-middle text-grey no-underline hover:text-black border-b-2 border-white hover:border-purple">
                            <i class="fa fa-cogs fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Providers</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <a href="{{ route('admin.categories.index') }}" class="block py-1 md:py-3 pl-1 align-middle text-grey no-underline hover:text-black border-b-2 border-white hover:border-green">
                            <i class="fas fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Categories</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <a href="{{ route('admin.users.index') }}" class="block py-1 md:py-3 pl-1 align-middle text-grey no-underline hover:text-black border-b-2 border-white hover:border-red">
