...
@section('content')
    <form class="w-full" method="POST" action="{{ route('admin.providers.create') }}">
        @csrf
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <div class="w-full md:w-1/2 px-3">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight" name="scrape_url" id="grid-scrape-url" type="text">
