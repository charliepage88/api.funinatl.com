...
@section('content')
    <form class="form" method="POST" action="{{ route('admin.locations.create') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="columns is-multiline">
            ...
            <div class="column is-half">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input is-medium" type="text" name="address" value="{{ old('address') }}">
                    </div>
            ...
            <div class="column is-one-quarter">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input is-medium" type="text" name="city" value="{{ old('city') }}">
                    </div>
            ...
            <div class="column is-one-quarter">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input is-medium" type="text" name="zip" value="{{ old('zip') }}">
                    </div>
