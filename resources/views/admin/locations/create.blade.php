...
@section('content')
    <form class="w-full" method="POST" action="{{ route('admin.locations.create') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <div class="w-full md:w-1/3 px-3">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight" name="website" id="grid-website" type="text">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <div class="w-full md:w-2/3 px-3">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:border-gray-500" name="address" id="grid-address" type="text">
        ...
        <div class="flex flex-wrap -mx-3 mb-2">
            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-city" type="text" name="city">
            ...
            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-zip" type="text" name="zip">
